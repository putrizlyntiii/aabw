...
<section class="section">
          <div class="section-header">
            <!-- <h1>Blank Page</h1> -->
             <a href="<?=site_url('akun3/new')?>" class="btn btn-primary"> Back</a>
          </div>
<div class="card">
            <div class="card-header">
                    <h4>Tambah data Akun3</h4>
                  </div>
                  <div class="card-body p-4">
                    ...
                    <div class="form-group">
                     ...
                     <div class="form-group">
                         <button type="submit" class="btn btn-success"><i class="fas fa-paper-plane"i></i> Save</button>
