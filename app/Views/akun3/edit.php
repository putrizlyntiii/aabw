            ...
            <div class="card-body p-4">
                ...
                <form method="post" action="<?= site_url('akun3/'. $dtakun3->id_akun3) ?>">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="kode_akun3" placeholder="Kode Akun 3" value="<?= $dtakun3->kode_akun3 ?>" 
                    </div>
                    <div class="form-group">
                        <label>Nama Akun 2</label>
                        <input type="text" class="form-control" name="nama_akun3" placeholder="Nama Akun 3" value="<?= $dtakun3->nama_akun3 ?>" 
                    <div class="form-group">
