            ...
            <div class="card-body p-4">
                <form method="post" action="<?= site_url('transaksi/' . $dttransaksi->id_transaksi . '/edit') ?>">
                    ...
                    <div class="form-group">
                        <label>Tanggal</label>
                        <input type="date" class="form-control" name="tanggal" required value="<?= esc($dttransaksi->tanggal) ?>">
                    </div>

                    <div class="form-group">
                        <label>Deskripsi</label>
                        <input type="text" class="form-control" name="deskripsi" required value="<?= esc($dttransaksi->deskripsi) ?>">
                    </div>

                    <div class="form-group">
                        <label>Ket Jurnal</label>
                        <input type="text" class="form-control" name="ketjurnal" required value="<?= esc($dttransaksi->ketjurnal) ?>">
                    </div>
                                ...
                                <?php foreach ($dtnilai as $i => $item) : ?>
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <input type="hidden" name="id_nilai[]" required value="<?= esc($item->id_nilai) ?>">
                                        </td>
                                    </tr>
                                <?php endforeach; ?>
                            </tbody>
