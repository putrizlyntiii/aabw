<li class="menu-header">Dashboard</li>
                        ...
                        <li class="#"><a class="nav-link" href="blank.html"><i class="fas fa-book"></i> <span>Jurnal Umum</span></a></li>
                        <li class="#"><a class="nav-link" href="blank.html"><i class="fas fa-folder-plus"></i> <span>Posting</span></a></li>
                        <li class="#"><a class="nav-link" href="blank.html"><i class="fas fa-balance-scale"></i> <span>Neraca Saldo</span></a></li>
                        <li class="#"><a class="nav-link" href="blank.html"><i class="fas fa-calculator"></i> <span>Neraca Lajur</span></a></li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="nav-link" href="<?= site_url('transaksi') ?>">Transaksi Penyesuaian</a></li>
                            </ul>
                        </li>
