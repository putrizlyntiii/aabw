<li class="menu-header">Dashboard</li>
                        ...
                        <li class="#"><a class="nav-link" href="<?= site_url('jurnalumum') ?>"><i class="fas fa-calender-alt"></i> <span>Jurnal Umum</span></a></li>
                        <li class="#"><a class="nav-link" href="<?= site_url('posting') ?>"><i class="fas fa-folder-plus"></i> <span>Posting</span></a></li>
                        <li class="#"><a class="nav-link" href="<?= site_url('neracasaldo') ?>"><i class="fas fa-balance-scale"></i> <span>Neraca Saldo</span></a></li>
                        <li class="#"><a class="nav-link" href="<?= site_url('neracalajur') ?>"><i class="fas fa-calculator"></i> <span>Neraca Lajur</span></a></li>
